			...
			<div className={needMB && (needCheckBox || needRadio) ? "flex mb-3 justify-center" : needMB ? "flex mb-3" : "flex"}>
				{needRadio && (
					<div className="flex mr-10 justify-center items-center">
						<input className="rounded-lg h-5 w-5" type="radio" id="selectcontact" name="selectcontact" required></input>
					</div>
				)}
				...
				{needCheckBox && (
					<div className="flex ml-24 justify-center items-center">
						<input className="rounded-lg h-5 w-5" type="checkbox" id="selectcontact" required></input>
					</div>
				)}
			</div>
		</>
