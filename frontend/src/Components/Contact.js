export default function Contact({ needMB, needCheckBox, needRadio, contact, setAllCheckedBoxes, fromList }) {
	return (
		<>
			<label className={needMB ? "flex justify-around" : "flex mb-3 justify-around"}>
				...
				<div className={fromList ? "w-40 ml-5 text-sm flex flex-col justify-center" : "w-40 text-sm flex flex-col justify-center"}>
