...
export default function Login() {
	return (
		<>
			<div className="flex m-16 justify-between px-10 shadow-2xl rounded-lg bg-slate-300" style={{ height: "700px" }}>
				<div className="flex flex-col justify-center ml-16">
					<form action="" method="post">
						...
						<input className="rounded-lg h-8 w-60 mb-10 px-3 focus:outline-none text-sm font-light py-2" type="text" id="patoken" required></input>
						<button className="rounded-full h-8 w-60 bg-yellow-400 text-sm mb-6">REGISTER</button>
					</form>
					<div className="mb-6 mt-4">
						<hr className="border-slate-400 w-72 mb-6"></hr>
