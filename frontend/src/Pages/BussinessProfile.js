					...
					<div className="rounded-lg px-9 py-7 flex flex-col justify-center panelShadow bg-white" style={{ height: "575px", width: "450px" }}>
						<div className="flex flex-row justify-between items-center mb-6">
							<div className="flex flex-col">
								...
								<input className="h-8 mb-4 text-sm font-medium py-3" type="text" id="businessname" defaultValue="The Garage Shop" readOnly></input>
								<label className="text-sm font-normal text-slate-900 mb-1">Mobile Number</label>
								<input className="h-8 text-sm font-medium py-3" type="text" id="mobilenumber" defaultValue="+919871234580" readOnly></input>
							</div>
						...
						<form action="" method="post" className="flex flex-col justify-between">
							...
							<input className="rounded-lg inputShadow h-9 w-full mb-4 px-3 text-xs font-medium py-3" type="text" id="description" placeholder="Add description"></input>
							<label className="text-sm font-normal text-slate-900 mb-2">Address</label>
							<input className="rounded-lg inputShadow h-9 w-full mb-4 px-3 text-xs font-medium py-3" type="text" id="address" placeholder="Add your address"></input>
							<label className="text-sm font-normal text-slate-900 mb-2">Email</label>
							<input className="rounded-lg inputShadow h-9 w-full mb-4 px-3 text-xs font-medium py-3" type="email" id="email" placeholder="Add your email"></input>
							<div className="flex flex-row justify-between">
								...
								<div className="flex flex-col">
									...
									<input className="rounded-lg inputShadow h-9 w-44 mb-4 px-3 text-xs font-medium py-3" type="url" placeholder="Add your website"></input>
								</div>
							</div>
