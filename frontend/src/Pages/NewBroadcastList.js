			...
			<section className="flex justify-center items-center h-screen">
				<div className="rounded-lg p-7 flex flex-col panelShadow" style={{ height: "500px", width: "400px" }}>
					<div className="flex flex-col">
						...
						<input className="rounded-lg inputShadow h-9 w-full mb-4 px-3 text-xs font-light py-3" type="text" id="bclname" placeholder="Name of the broadcast list" required></input>
					</div>
