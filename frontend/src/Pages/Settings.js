				...
				<section className="flex justify-center items-center mt-20">
					<div className="rounded-lg p-7 flex flex-col justify-center panelShadow bg-white" style={{ height: "500px", width: "500px" }}>
						...
						<form action="" method="post" className="flex flex-col justify-between">
							...
							<input
								className="rounded-lg inputShadow h-9 w-full mb-6 px-3 focus:outline-none text-sm font-light py-2"
								type="text"
								pattern="[6789][0-9]{9}"
								maxLength="10"
								placeholder="App ID"
							...
							<input className="rounded-lg inputShadow h-9 w-full mb-6 px-3 focus:outline-none text-sm font-light py-2" type="text" id="wabaid" placeholder="App Secret" required></input>
